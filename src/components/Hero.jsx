    ...
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        <div className='flex flex-col justify-center items-center mt-5'>
          ...
          <div className='w-1 sm:h-80 h-35 violet-gradient' />
        </div>
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-1 mb-3 text-white-98`}>
            I develop  interactive designs, user <br className='sm:block hidden' />
